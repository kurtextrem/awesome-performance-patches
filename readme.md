...
- [HTML & Core Web Vitals](html--core-web-vitals-)
...
- [npm scripts](https://marvinh.dev/blog/speeding-up-javascript-ecosystem-part-4/) - see also [Reducing overhead of npm run](https://viniciusl.com.br/posts/2024/06/29-reducing-overhead-of-npm-run/) - load modules lazily (_caution: switching to `Intl.Collator` might nowadays be slower._)
